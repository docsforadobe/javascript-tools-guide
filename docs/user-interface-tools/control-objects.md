...
Used by the [LayoutManager object](layoutmanager-object.md) to determine the default
...
pathname or [File object](../file-system-access/file-object.md) for a file that contains a platform-specific
...
expected return values; see [Defining behavior with event callbacks and listeners](defining-behavior-with-event-callbacks-and-listeners.md).
